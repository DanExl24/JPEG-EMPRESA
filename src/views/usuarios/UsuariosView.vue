      ...
      <div class="p-4 border-b border-gray-100 flex items-center gap-3">
        <div class="flex-1 relative">
          ...
          <input
            ...
            class="w-full pl-9 pr-4 py-2 bg-gray-50 rounded-xl text-sm outline-none border border-gray-200 focus:ring-2 focus:ring-[#006688]/20"
          />
        </div>
        <select
          v-model="filterRole"
      ...
      <div class="overflow-x-auto">
        <table class="w-full">
          <thead>
            <tr class="bg-gray-50">
              <th
                class="text-left text-xs font-bold text-gray-400 uppercase tracking-wider px-5 py-3"
              >
                Usuario
              </th>
              <th
            ...
            >
              <td class="px-5 py-4">
                <div class="flex items-center gap-3">
                  <div
                    :class="`w-9 h-9 rounded-full flex items-center justify-center text-sm font-bold shrink-0 ${user.avatarBg}`"
              ...
              <td class="px-5 py-4">
                <span
                  :class="`text-xs font-bold px-2 py-1 rounded-full ${user.roleBg} ${user.roleText}`"
                  >{{ user.roleLabel }}</span
                >
              </td>
              ...
              <td class="px-5 py-4">
                <span
                  :class="`flex items-center gap-1 text-xs font-semibold ${user.active ? 'text-green-600' : 'text-gray-400'}`"
                >
                  <span
