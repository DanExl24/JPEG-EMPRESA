...
const PHRASE_DICTIONARY: Record<'en' | 'pt', Record<string, string>> = {
  en: {
    ...
    'Reanudar Módulo': 'Resume Module',
    'Comenzar Reto': 'Start Challenge',
    'Nivel': 'Level',
    'Aprendiz Novato': 'Novice Apprentice',
    'Asistente Clínico': 'Clinical Assistant',
    'Cuidador Especializado': 'Specialized Caregiver',
    'Líder de Enfermería': 'Nursing Leader',
    'Maestro Clínico': 'Clinical Master',
    'Cuadro de Honor': 'Honor Roll',
    'Mi Curso en Curso': 'My Current Course',
    'Fase de Estudio:': 'Study Phase:',
    'Misiones y Retos Recomendados': 'Recommended Quests & Challenges',
    'Mis Logros y Medallas Recientes': 'Recent Achievements & Badges',
    'Mis Entregas y Calificaciones': 'My Submissions & Grades',
    'Ver todos los logros': 'View all achievements',
    'Ver historial completo': 'View full history',
    '¡Al día! Has completado todas las actividades disponibles.': 'All caught up! You have completed all available activities.',
    'Sin entregas realizadas aún. ¡Comienza un reto para sumar XP!': 'No submissions yet. Start a challenge to earn XP!',
    'Aprobado': 'Passed',
    'En Revisión': 'Under Review',
    'Fase': 'Phase',
    'Fase 1: Inicio': 'Phase 1: Start',
    'Fase 2: Estudio': 'Phase 2: Study',
    'Fase 3: Práctica': 'Phase 3: Practice',
    'Fase 4: Evaluación': 'Phase 4: Assessment',
    'Retos Superados': 'Challenges Passed',
    'Insignias Obtenidas': 'Badges Earned',
    'Mi Progreso Global': 'My Overall Progress',
  ...
  pt: {
    ...
    'Reanudar Módulo': 'Retomar Módulo',
    'Comenzar Reto': 'Iniciar Desafio',
    'Nivel': 'Nível',
    'Aprendiz Novato': 'Aprendiz Novato',
    'Asistente Clínico': 'Assistente Clínico',
    'Cuidador Especializado': 'Cuidador Especializado',
    'Líder de Enfermería': 'Líder de Enfermagem',
    'Maestro Clínico': 'Mestre Clínico',
    'Cuadro de Honor': 'Quadro de Honra',
    'Mi Curso en Curso': 'Meu Curso em Andamento',
    'Fase de Estudio:': 'Fase de Estudo:',
    'Misiones y Retos Recomendados': 'Missões e Desafios Recomendados',
    'Mis Logros y Medallas Recientes': 'Minhas Conquistas e Medalhas Recentes',
    'Mis Entregas y Calificaciones': 'Minhas Entregas e Avaliações',
    'Ver todos los logros': 'Ver todas as conquistas',
    'Ver historial completo': 'Ver histórico completo',
    '¡Al día! Has completado todas las actividades disponibles.': 'Tudo em dia! Você concluiu todas as atividades disponíveis.',
    'Sin entregas realizadas aún. ¡Comienza un reto para sumar XP!': 'Nenhuma entrega realizada ainda. Comece um desafio para ganhar XP!',
    'Aprobado': 'Aprovado',
    'En Revisión': 'Em Revisão',
    'Fase': 'Fase',
    'Fase 1: Inicio': 'Fase 1: Início',
    'Fase 2: Estudio': 'Fase 2: Estudo',
    'Fase 3: Práctica': 'Fase 3: Prática',
    'Fase 4: Evaluación': 'Fase 4: Avaliação',
    'Retos Superados': 'Desafios Superados',
    'Insignias Obtenidas': 'Medalhas Obtidas',
    'Mi Progreso Global': 'Meu Progresso Geral',
    'Puntos de Experiencia (XP)': 'Pontos de Experiência (XP)'
  }
}
